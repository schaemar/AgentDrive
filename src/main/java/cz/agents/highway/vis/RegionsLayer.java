...
public class RegionsLayer extends AbstractLayer {
    ...
    private cz.agents.highway.environment.planning.euclid4d.Region region;
    ...
    public RegionsLayer(cz.agents.highway.environment.planning.euclid4d.Region region, TimeParameter timeParameter, Color edgeColor, Color fillColor, int id) {
        this.region = region;
