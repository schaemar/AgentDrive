...
import cz.agents.agentdrive.simulator.lite.visualization.AgentDriveVisLayer;
import cz.agents.agentdrive.simulator.lite.visualization.NetLayer;
import cz.agents.agentdrive.simulator.lite.visualization.RoadObjectLayer;
...
public class DefaultCreator implements Creator {
    ...
    public void create() {
        ...
        if (Configurator.getParamBool("simulator.lite.vis.isOn", false)) {
            ...
            VisManager.registerLayer(AgentDriveVisLayer.create(highwayEnvironment.getStorage()));
