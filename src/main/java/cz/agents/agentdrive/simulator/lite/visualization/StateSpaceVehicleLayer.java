...
public class StateSpaceVehicleLayer extends CommonLayer {
    ...
    public String getLayerDescription() {
        String description = "[Vis StateSpace] The layer shows StateSpace of each agent (SDAgent) info in lower right corner, you can change selected vehicle by pressing 't' to hide window press 'u'";
